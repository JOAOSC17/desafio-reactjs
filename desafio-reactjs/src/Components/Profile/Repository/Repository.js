...
Donec a pulvinar est. Vivamus et venenatis felis, sed sodales enim. Nulla hendrerit rutrum diam, </p>
                <div className="profiles-repository-info">
                 <span><BsStar/> {`${repository[0].star} stars`}</span>
